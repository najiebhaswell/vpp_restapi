...
// source: plugins/lcpng_if.api.json

// Package lcpng_if contains generated bindings for API file lcpng_if.api.
//
// Contents:
// -  1 enum
// - 17 messages
...
// get the default Linux Control Plane netns
//   - netns - the default netns; netns[0] == 0 iff none
//
...
//   - netns - the new default netns; netns[0] == 0 iff none
//
...
//   - netns - optional tap netns; netns[0] == 0 iff none
//
...
func init() { file_lcpng_if_binapi_init() }
func file_lcpng_if_binapi_init() {
