...
// RPCService defines RPC service lcpng_if.
type RPCService interface {
	...
	LcpItfPairGetV2(ctx context.Context, in *LcpItfPairGetV2) (*LcpItfPairGetV2Reply, error)
...
func (c *serviceClient) LcpItfPairGetV2(ctx context.Context, in *LcpItfPairGetV2) (*LcpItfPairGetV2Reply, error) {
	out := new(LcpItfPairGetV2Reply)
	err := c.conn.Invoke(ctx, in, out)
	if err != nil {
		return nil, err
	}
